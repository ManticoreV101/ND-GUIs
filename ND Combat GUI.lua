...
window:AddButton("Unsheathe Sleeve",function()
...
window:AddButton("Sever Artery",function()
...
window:AddButton("Stab Nerve Cluster",function()
...
window:AddButton("Stab Armpit",function()
...
window:AddButton("Sheathe Sleeve",function()
...
window:AddButton("Unsheathe Cloak",function()
...
window:AddButton("Throw Blades",function()
...
window:AddButton("Head",function()
...
window:AddButton("Lungs",function()
                    local args = {
...
window:AddButton("Femur",function()
...
window:AddButton("Animation",function()
...
window:AddButton("Engage",function()
...
window:AddButton("Disengage",function()
...
window:AddButton("Silent Engage",function()
...
window:AddButton("Silent Disengage",function()
...
window:AddButton("Silent Disguise",function()
...
window:AddButton("Parallel",function()
...
window:AddButton("Defensive",function()
...
window:AddButton("Zenkutsu",function()
...
window:AddButton("Foundational",function()
...
window:AddButton("Unholster RSh-12",function()
...
window:AddButton("Unholster Walther SP22",function()
...
window:AddButton("Safety Off",function()
...
window:AddButton("Load RSh-12",function()
...
window:AddButton("Load Walther SP22",function()
...
window:AddButton("Death-Aim At Head",function()
...
window:AddButton("Threat-Aim At Head",function()
...
window:AddButton("Aim at Torso",function()
...
window:AddButton("Fire Head",function()
...
window:AddButton("Fire Torso",function()
...
window:AddButton("Safety On",function()
...
window:AddButton("Holster",function()
...
window:AddButton("Discombobulate",function()
...
window:AddButton("Elbow Jaw",function()
...
window:AddButton("Hammer Fist",function()
...
window:AddButton("Damage Windpipe",function()
...
window:AddButton("Traumatize Solar Plexus",function()
...
window:AddButton("Double-Fist Strike",function()
...
window:AddButton("Spinning Back-Fist",function()
...
window:AddButton("Fracture Ribs",function()
...
window:AddButton("Shatter Ribs",function()
...
window:AddButton("Paralyze Arms",function()
...
window:AddButton("Bash Face Into Knee",function()
...
window:AddButton("Clap Ears",function()
...
window:AddButton("Strike Temple",function()
...
window:AddButton("Plunge Fingers Into Eyes",function()
...
window:AddButton("Rip Eyes Out",function()
...
window:AddButton("Chokehold",function()
...
window:AddButton("Open Palm Into Nose",function()
...
window:AddButton("Brachial Plexus",function()
...
window:AddButton("Roundhouse Kick",function()
...
window:AddButton("Horse Kick",function()
...
window:AddButton("Axe Kick",function()
...
window:AddButton("Crescent Kick",function()
...
window:AddButton("Front Hook Kick",function()
...
window:AddButton("Double Dropkick",function()
...
window:AddButton("Break Helmet",function()
...
window:AddButton("Break Mask",function()
...
window:AddButton("Break Visor",function()
...
window:AddButton("Break Face",function()
...
window:AddButton("Slam Against Wall",function()
...
window:AddButton("Slam Against Counter",function()
...
window:AddButton("Slam Against Pillar",function()
...
window:AddButton("Smash Face Into Wall",function()
...
window:AddButton("Dodge",function()
...
window:AddButton("Catch and Twist Arm",function()
...
window:AddButton("Catch and Sweep Leg",function()
...
window:AddButton("Disarm Gun",function()
...
window:AddButton("Disarm Weapon",function()
...
window:AddButton("Get Up",function()
...
window:AddButton("Hoist",function()
...
window:AddButton("Tackle",function()
...
window:AddButton("Pin Down",function()
...
window:AddButton("Restrain",function()
