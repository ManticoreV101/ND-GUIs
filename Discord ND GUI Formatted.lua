...
local L_3_ = L_2_:Server("Combat", "http://www.roblox.com/asset/?id=4483345998")

local L_4_ = L_3_:Channel("Melee Combat")
...
L_4_:Button(
	...
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(unpack(L_20_))
	wait(1.3)
	local L_21_ = {
		[1] = "I'd now grip the blade, inclined to strike",
		[2] = "All"
	}
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(unpack(L_21_))
end
)
...
L_4_:Button(
	...
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(unpack(L_22_))
	wait(2)
	local L_23_ = {
		[1] = "I'd now yank the blade back, retracting it out of your neck",
		[2] = "All"
	}
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(unpack(L_23_))
	wait(2.1)
	local L_24_ = {
		[1] = "I'd now jab my knife, whereas its edge was angled towards your larynx",
		[2] = "All"
	}
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(unpack(L_24_))
	wait(2.3)
	local L_25_ = {
	...
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(unpack(L_26_))
	wait(1.9)
	local L_27_ = {
...
L_4_:Button(
	...
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(unpack(L_28_))
	wait(2)
	local L_29_ = {
		[1] = "The blade would thrust into a nerve cluster, severing multiple nerves",
		[2] = "All"
	}
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(unpack(L_29_))
	wait(1.9)
	local L_30_ = {
		[1] = "I'd yank my blade back, placing it in my grip again",
		[2] = "All"
	}
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(unpack(L_30_))
end
)
L_4_:Button(
    "Stab Armpit",
	...
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(unpack(L_31_))
	wait(2)
	local L_32_ = {
...
local L_5_ = L_3_:Channel("Suit Control")

L_5_:Button(
    "Animation",
    function()
	local L_47_ = game:GetService("Players")
	local L_48_ = L_47_.LocalPlayer.Character.Animate
	L_48_.idle.Animation1.AnimationId = "rbxassetid://5319828216"
	L_48_.idle.Animation2.AnimationId = "rbxassetid://5319831086"
	L_48_.run.RunAnim.AnimationId = "rbxassetid://5319844329"
	L_48_.walk.WalkAnim.AnimationId = "rbxassetid://5319847204"
	L_48_.jump.JumpAnim.AnimationId = "rbxassetid://5319841935"
	L_48_.climb.ClimbAnim.AnimationId = "rbxassetid://5319816685"
	L_48_.fall.FallAnim.AnimationId = "rbxassetid://5319839762"
	L_48_.swim.Swim.AnimationId = "rbxassetid://5319850266"
	L_48_.swimidle.SwimIdle.AnimationId = "rbxassetid://5319852613"
end
)
...
L_5_:Button(
	...
	game:GetService("ReplicatedStorage").Events.customizePlayer:InvokeServer(unpack(L_50_))
end
)
...
L_5_:Button(
	...
	game:GetService("ReplicatedStorage").Events.customizePlayer:InvokeServer(unpack(L_52_))
end
)
...
L_5_:Button(
	...
	game:GetService("ReplicatedStorage").Events.customizePlayer:InvokeServer(unpack(L_53_))
end
)
...
L_5_:Button(
	...
	game:GetService("ReplicatedStorage").Events.customizePlayer:InvokeServer(unpack(L_54_))
end
)
...
L_5_:Button(
	...
	game:GetService("ReplicatedStorage").Events.customizePlayer:InvokeServer(unpack(L_55_))
end
)

local L_6_ = L_3_:Channel("Firearms")
...
local L_7_ = L_3_:Channel("Hand-Hand")
...
local L_9_ = L_3_:Channel("Retaliate")
...
local L_10_ = L_3_:Channel("Self-Defense")
...
local L_11_ = L_3_:Channel("Gore Combat")
...
local L_12_ = L_3_:Channel("Robot Combat")
L_12_:Button(
    "Load AP LI Baron",
    function()
	local L_192_ = {
...
local L_13_ = L_3_:Channel("Bullet C-A")
...
L_13_:Button(
	...
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(unpack(L_235_))
	wait(2)
	local L_236_ = {
		[1] = "The  blend of Nomex and Kevlar aramids, with polyethylene sheets sandwiching the plate padding reduces the impact shock",
		[2] = "All"
...
local L_14_ = L_2_:Server("Location", "http://www.roblox.com/asset/?id=3192485348")

local L_15_ = L_14_:Channel("Amery | Normal")
L_15_:Button(
    "Enter Building",
    function()
	local L_237_ = {
...
local L_16_ = L_14_:Channel("Amery | Banquet")
L_16_:Button(
    "Enter Building",
    function()
	local L_248_ = {
...
local L_17_ = L_14_:Channel("Lone Ranger")
L_17_:Button(
    "Enter Bar",
    function()
	local L_260_ = {
...
local L_18_ = L_2_:Server("Utility", "http://www.roblox.com/asset/?id=6031075938")
local L_19_ = L_18_:Channel("N/A")
