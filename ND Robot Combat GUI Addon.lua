...
window:AddButton("Load AP RSh-12",function()
    local args = {
...
window:AddButton("AP Left Arm",function()
    local args = {
...
window:AddButton("AP Right Arm",function()
    local args = {
...
window:AddButton("Flash",function()
